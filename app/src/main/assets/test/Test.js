...
(function (test) {
    ...
    var MyTest = (function () {
        ...
        MyTest.prototype.stop = function () {
        };
        MyTest.prototype.sendOneTransaction = function () {
        };
        MyTest.prototype.test001 = function () {
            var address = '0x35bc7e479cd875f379bfd32e382216e318d1ca1a';
        ...
        MyTest.prototype.test1 = function () {
            console.warn('test 1');
            var ctr = this.main.getCryptoControllerByName('Ethereum');
        ...
        MyTest.prototype.test2 = function () {
            console.warn(' test 2 ');
            var ctr = this.main.getCryptoControllerByName('Ethereum');
            // ctr.resetTempBalances();
        };
        MyTest.prototype.test3 = function () {
            this.testSEnd.sendOne();
            //sending
        ...
        MyTest.prototype.test5 = function () {
            console.log('test 5');
            this.ctr = this.main.getCryptoControllerByName('Ethereum');
            var start = Date.now();
            var service = this.ctr._accountService;
            var addresses = [];
        ...
        MyTest.prototype.test6 = function () {
            console.log('test 6');
            var start = Date.now();
            for (var i = 0; i < 20; i++) {
                var uri = '0x86abFd0FC05a736D32AB265050Ee994e93d91d80 0x86abFd0FC05a736D32AB265050Ee994e93d91d80' + i;
        ...
        MyTest.prototype.runTest2 = function () {
        ...
        MyTest.prototype.getTrm = function () {
            return this.main._currentCryptoController;
        };
        MyTest.prototype.runTest = function () {
            ...
            // out.shift();
            console.log(out);
            var amount = jaxx.Utils.calculateBalanceSpendable(out, fee);
            var transaction = new VOSendTransaction();
