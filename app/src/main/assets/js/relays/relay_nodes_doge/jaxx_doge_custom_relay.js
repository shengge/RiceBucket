var DogeJaxxCustomRelay = function() {
    this._baseUrl = "https://api.jaxx.io/api/doge/";
    ...
    this._name = "Jaxx Doge Custom API";
    this._reliable = "true";
    this._lastBlock = 0;
...
DogeJaxxCustomRelay.prototype.initialize = function(relayManager) {
  this._relayManager = relayManager;
}

DogeJaxxCustomRelay.prototype.getLastBlockHeight = function(){
  // This function shares a common interface with the other relays.
  return this._lastBlock;
}

DogeJaxxCustomRelay.prototype.setLastBlockHeight = function(newHeight){
...
DogeJaxxCustomRelay.prototype.fetchLastBlockHeight  = function(callback, passthroughParams) {
  ...
  // https://api.jaxx.io/api/doge/blockchainInfo // url
...
DogeJaxxCustomRelay.prototype.checkCurrentHeightForAnomalies  = function() {
...
DogeJaxxCustomRelay.prototype.getTxList  = function(addresses, callback, passthroughParams) {
    ...
    RequestSerializer.getJSON(requestString, function(response1, status1, passthroughParams) {
        ...
        if(status==='error'){
            ...
            //   console.warn('getJSON   '+ urlUnconfirmed);
...
//            console.log(passthrough.response)
    ...
    /* this._relayManager.relayLog("Chain Relay :: " + this._name+ " - Requested txlist for " + addresses);
     ...
     // https://api.jaxx.io/api/doge/transactions/DFNLQQWP4aDwXQyuKgLJWRdmWdodvY41mP // requestString
...
DogeJaxxCustomRelay.prototype.getTxListParse = function(primaryTxListData) {
  var returnData = {data: []};
...
DogeJaxxCustomRelay.prototype.getTxCount = function(addresses, callback, passthroughParams) {
  var self = this;
...
DogeJaxxCustomRelay.prototype.getTxDetails = function(txHashes, callback, passthroughParams) {

//    console.log("DogeJaxxCustomRelay :: getTxDetails :: currently unimplemented");
  var self = this;
  ...
  // https://api.jaxx.io/api/ltc/transactionInfo/3b40250a08e7cb493981adfc6637235835998347e059565eb24f9d6268cea70f,9f4da4554f02c209e98040cc478720c922b50edb14f4071f8c4c73e74a9243bf // Sample requestString:
...
DogeJaxxCustomRelay.prototype.getTxDetailsParse = function(response) {
...
//}
  ...
  for (var idx = 0; idx < addressKeys.length; idx++) {
    ...
    var timestamp = Math.round(new Date(curData.time_utc).getTime() / 1000);
...
//DogeJaxxCustomRelay.prototype.getAddressBalance = function(address, callback, passthroughParams) {
...
//DogeJaxxCustomRelay.prototype.getFixedBlockHeight = function( address, callback, passthroughParams) {
//    var self = this;
//
...
DogeJaxxCustomRelay.prototype.getUTXO = function(addresses, callback, passthroughParams) {
  if (!callback) {
...
DogeJaxxCustomRelay.prototype.getUTXOParse = function(response){
  returnData = {};
...
DogeJaxxCustomRelay.prototype.pushRawTx  = function(hex, callback) {
...
DogeJaxxCustomRelay.prototype.getRelayType = function() {
  return 'DogeJaxxCustomRelay';
}

DogeJaxxCustomRelay.prototype.getRelayTypeWithCallback = function(callback, passthroughParams) {
  var relayName = 'DogeJaxxCustomRelay';
  callback("success", relayName, passthroughParams);
  return relayName;
}

DogeJaxxCustomRelay.prototype.getRelayTypeWithCallbackForgettingStatus = function(callback) {
  var relayName = 'DogeJaxxCustomRelay';
  callback(relayName);
  return relayName;
}
...
if (typeof(exports) !== 'undefined') {
  exports.relayJaxxCustom = DogeJaxxCustomRelay;
}

DogeJaxxCustomRelay.prototype.getMultiAddressBalance = function(addresses, callback, passthroughParams) {
...
DogeJaxxCustomRelay.prototype.getMultiAddressBalanceParse = function(response){
    var returnData = [];
