...
ZECJaxxCustomRelay.prototype.getTxList  = function(addresses, callback, passthroughParams) {
   // this._relayManager.relayLog("Chain Relay :: " + this._name+ " - Requested txlist for " + addresses);
    ...
    var urlUnconfirmed = 'https://api.jaxx.io/api/zec/unconfirmedTransactions/'+addresses+'';
    ...
    RequestSerializer.getJSON(requestString, function(response, status, passthroughData) {
        ...
        if(status==='error'){
            ...
            callback(status, null, passthroughData.passthroughParams);
        }
        else {
...
ZECJaxxCustomRelay.prototype.getTxListAppendUnconfirmedTransactions = function(confirmedListData,unconfirmedListData){
...
ZECJaxxCustomRelay.prototype.getUTXO  = function(addresses, callback, passthroughParams) {
...
ZECJaxxCustomRelay.prototype.getUTXOParse = function(response){
    returnData = {};
...
ZECJaxxCustomRelay.prototype.getMultiAddressBalance = function(addresses, callback, passthroughParams) {
...
ZECJaxxCustomRelay.prototype.getMultiAddressBalanceParse = function(response) {
    var returnData = [];
