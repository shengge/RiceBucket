...
HDWalletWorkerEthereumClassic.prototype.performRecheck = function() {
    ...
    //@note: @todo: @here: @critical: @hack: this is absolutely incorrect. the final update call absolutely needs to finish with a callback to *post only after the fact. this hack is due to time constraints. sept 12 2016 - chris. // also, the regular ethereum wallet actually does do this correctly, for reference.
    var self = this;
    setTimeout(function() {
