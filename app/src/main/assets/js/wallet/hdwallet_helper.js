...
HDWalletHelper.baseInitialCryptoCurrencies = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": true, "LTC": true, "LSK": false, "ZEC": false, "SBTC": true, "DOGE": false}//,
//    "ios": {"BTC": true, "ETH": true, "DAO": true, "DASH": false, "ETC": true}
}

HDWalletHelper.cryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": true, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE": false},
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": true, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE": false}
}

HDWalletHelper.shapeShiftCryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": true, "LTC": true, "LSK": false, "ZEC": true, "SBTC": false, "DOGE": false},
}

HDWalletHelper.privateKeyCryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE":false},
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": false, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": true, "DOGE":false}
}
...
HDWalletHelper.paperWalletsCryptoCurrenciesAllowed = {
    "regular": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": false, "DOGE": false},
    "ios": {"BTC": true, "ETH": true, "DAO": false, "DASH": true, "ETC": true, "REP": false, "LTC": true, "LSK": false, "ZEC": true, "SBTC": false, "DOGE": false}
}
...
HDWalletHelper.prototype._updateExchangeRates = function(){
    //_______________________________________console.log('Running :: _updateExchangeRates called');
...
//                console.log('Exchange Rate Log :: _updateExchangeRates called and inside loop with coinType: ' + coinTypeCounter);
                if (coinTypeCounter === COIN_BITCOIN) {
                    ...
                    //_____________________________        console.log("error :: to get exchange rates for :: " + coinTypeCounter);
                            continue;
                        }
                        ...
                        if (Object.keys(self._exchangeRates[coinTypeCounter]).length === 0 || self._exchangeRates[coinTypeCounter]['USD'] != coinToUsd) {
                            ...
                            for (var currency in self._exchangeRates[COIN_BITCOIN]) {
                                ...
                                var tempRate = {};
                                tempRate['ask'] = (self._exchangeRates[COIN_BITCOIN][currency]['ask'] * btcToCoin).toFixed(8);
                                tempRate['bid'] = (self._exchangeRates[COIN_BITCOIN][currency]['bid'] * btcToCoin).toFixed(8);
                                tempRate['last'] = (self._exchangeRates[COIN_BITCOIN][currency]['last'] * btcToCoin).toFixed(8);
