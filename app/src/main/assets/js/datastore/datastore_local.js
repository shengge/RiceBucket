...
(function (jaxx) {
    var JaxxDatastoreLocal = (function () {
        ...
        JaxxDatastoreLocal.prototype.getAddressesNot0 = function (fee) {
            if (fee === void 0) { fee = 0; }
            return jaxx.Utils.getIds(this.getBalancesNot0(fee));
        };
        JaxxDatastoreLocal.prototype.getBalancesNot0 = function (fee) {
            if (fee === void 0) { fee = 0; }
        ...
        JaxxDatastoreLocal.prototype.getAddressesNo0Receive = function (fee) {
            if (fee === void 0) { fee = 0; }
            return jaxx.Utils.getIds(this.getBalancesNot0Receive(fee));
        };
        JaxxDatastoreLocal.prototype.getBalancesNot0Receive = function (fee) {
            if (fee === void 0) { fee = 0; }
            var out = [];
        ...
        JaxxDatastoreLocal.prototype.getBalancesReceiveNot0WithSpend = function () {
            var out = [];
        ...
        JaxxDatastoreLocal.prototype.getBalancesIndexedReceiveNot0WithIndex = function () {
        ...
        JaxxDatastoreLocal.prototype.getBalancesIndexedChangeNot0WithIndex = function () {
            var ballances = this.getBalancesChange();
        ...
        JaxxDatastoreLocal.prototype.getBalanceTotal = function () {
            //TODO chace it
        ...
        JaxxDatastoreLocal.prototype.getBalanceReceive = function () {
