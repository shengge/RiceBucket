...
(function () {
    ...
    window.console.error = function(err) {
        window.webkit.messageHandlers.Jaxx.postMessage({action: "console.error", message: err.message, stack: err.stack});
    };
...
//    console.log("window.iosdefaultprofilemode :: " + window.iosdefaultprofilemode);
    ...
    window.native = {
        ...
        copyToClipboard: function(textToCopy) {
            ...
            window.webkit.messageHandlers.Jaxx.postMessage({action: "native.copyToClipboard", textToCopy: textToCopy});
        },
