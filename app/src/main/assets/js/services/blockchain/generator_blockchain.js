...
(function (jaxx) {
    var GeneratorBlockchain = (function () {
        ...
        GeneratorBlockchain.prototype.generateAddressReceive = function (index) {
            ...
            var address = HDWalletPouch.getCoinAddress(this._coinType, jaxx.Utils2.getReceiveNode(this._coin_HD_index, index, coinNetwork));
            return address;
        ...
        GeneratorBlockchain.prototype.generateAddressChange = function (index) {
            var coinNetwork = HDWalletPouch.getStaticCoinPouchImplementation(this._coinType).networkDefinitions.mainNet;
            var address = HDWalletPouch.getCoinAddress(this._coinType, jaxx.Utils2.getChangeNode(this._coin_HD_index, index, coinNetwork));
            return address;
