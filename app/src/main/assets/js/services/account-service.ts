...
module jaxx {
    ...
    export class JaxxAccountService {
...
//////////////////////////////////////////////
        ...
        initTokenData(): void {
            ...
            let address: string = this.crypto_class.generator.generateAddressReceive(0);
        ...
        onDownloadedNewTransactions(transactions: VOTransaction[]): void {
            ...
            if (newTransactions.length) {
                ...
                setTimeout(() => this._downloadNewTranasctions(), 2000);
        ...
        downloadBalancesReceive(callBack: Function, onError: Function): void {
            ...
            this.downloadBalances(addresses).done(newbalances => {
                ...
                var balanceNew: number = this._db.getBalanceReceive();
        ...
        downloadBalancesChange(callBack: Function, onError: Function): void {
            ...
            this.downloadBalances(addresses).done(newbalances => {
                ...
                var delta: number = balanceOld - balanceNew;
                var precision = balanceNew / 1e5;
                ...
                if (Math.abs(delta) > precision) {
                    ...
                    let balanceOnCurrent: number = Utils.filterBalanceOnAddress(currentAddressChange, difference);
